...
export default class FileSystem
{
     ...
     */
    readFileStream(filePath, options)
    {
     ...
     * @private
     */
    _beautifyRelativePath(filePath)
    {
     ...
     */
    showOpenFolderDialog(title, initialPath, basePath, convertToRelative)
    {
     ...
     */
    showOpenFileDialog(title, initialPath, fileTypes, fileTypesPrefix, basePath, convertToRelative)
    {
        String.isString(initialPath) || (initialPath = '');
        const hasBasePath = !String.isEmpty(basePath);
